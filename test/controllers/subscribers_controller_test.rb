...
class SubscribersControllerTest < ActionController::TestCase
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post :create, subscriber: { latitude: @subscriber.latitude, longitude: @subscriber.longitude }
    end
  ...
  test "should update subscriber" do
    patch :update, id: @subscriber, subscriber: { latitude: @subscriber.latitude, longitude: @subscriber.longitude }
    assert_redirected_to subscriber_path(assigns(:subscriber))
  end
